...
export default function Footer() {
  return (
    <footer className="mx-auto max-w-3xl px-4 sm:px-6 md:max-w-5xl bg-blue950 border-0 bg-opacity-50 dark:bg-gray-800">
      ...
      <div className="mx-auto p-4 flex-col md:flex-row md:justify-between text-blue950 dark:text-gray-100 ">
      ...
      <div className="flex flex-col space-y-5 items-stretch justify-center align-top md:flex-row md:text-left md:p-4 md:space-y-0 md:space-x-5">
        <div className="md:w-1/2">
          <h4 className="text-amber500 text-s md:text-xs dark:text-neutral-100">Contacts</h4>
          <ul>
            <li className="text-blue950 dark:text-gray-100 text-x md:text-xs flex items-center">
